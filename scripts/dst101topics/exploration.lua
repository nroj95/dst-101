return {
    ...
    pages = {
        {
            illustration = "exploration_biome_edge",

            regions = {
                top_left = {
                    {
                        type = "headline",
                        text = "See what your world has",
                    },
                    {
                        type = "subtitle",
                        text = "The first few days are a good time to cover ground.",
                    },
                },
                ...
                illustration_caption = {
                    {
                        type = "caption",
                        text = "I want to know where this one comes out.",
                    },
                },
